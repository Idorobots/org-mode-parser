...
=org-parser= was created as an alternative to the wonderful, but admittedly incomplete and unmaintained [[https://github.com/karlicoss/orgparse/][=orgparse=]]. The main improvements on top of =orgparse= are:
