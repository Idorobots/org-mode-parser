...
* Overview
This project implements a Python parser for Emacs Org-Mode files providing nice semantic nodes.
It's based on the following Tree-Sitter grammar:
...
For more examples and documentation see [[docs/index.md][the documentation]].
